...
- 下游文档：`docs/planning/plan.md`、`docs/planning/tasks.md`、`AGENTS.md`
...
最终具体 ID 可在规则资料落地时确定，但一旦发布不应随显示名称变化。
...
| Incomplete Context | ✗ | 可复制暂定信息 | 可分享且必须标未确定 | ✓ |
...
14. Encyclopedia；
15. Saved Example；
16. Draft/Undo/Multi-tab；
17. Share/Copy；
18. JSON Import/Export；
19. Rule Snapshot/Migration；
20. PWA/Offline/Update；
21. Settings/Privacy/Feedback；
22. Accessibility；
23. Rule Test Corpus；
24. alpha/beta/rc 发布门槛。
...
- `plan.md` 以本架构为直接技术依据；
- `tasks.md` 按本架构模块拆分任务；
- `AGENTS.md` 必须约束 Codex 不绕过 Domain/Rule 边界；
